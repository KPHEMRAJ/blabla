...
class coinex:
    ...
    def depth(self,market,limit):
        url = self.url+"market/depth?market="+market+"&merge=0.00001&limit="+limit
    ...
    def deposit_address(self):
        url = self.url+"balance/deposit/address/vite?" + \
            "access_id="+self.access_id+"&tonce="+str(time_stamp())
        params = {
            "access_id": self.access_id,
            "tonce": str(time_stamp())
        }
